...
let people= {friends:[] as {firstName:string,lastName:string,id?:number }[] }
...
type Product = {name:string,model:number,cost:number,quantity:number,color?:string}
let product1:Product = {name:"Honda 125",model:2023 , cost:250000 ,quantity :10};
let product2:Product = {name:"Honda 150",model:2020 , cost:275000 ,quantity :5};
let product3 :Product= {name:"Honda CD70",model:2024 , cost:150000 ,quantity :15};
...
// 5. Explore adding and accessing more elements within the inventory array to understand how to manage product data.
 ...
 let product4:Product = {name:"Yamaha 125",model:2024 , cost:225000 ,quantity :15,color:"red"};
...
//  senior status (true/false), and whether they've completed their assignments (true/false).


// o Imagine this as a template for organizing student details.
interface Student   {name :string,seniorstatus:boolean;assignmentDone:boolean};
// 2. Student List:
// o An array named students stores information about several students using the Student template.


let student:Student[]=[] ;
let student1:  Student={name:"hira",seniorstatus:false,assignmentDone:true};
let student2 : Student={name:"hina",seniorstatus:true,assignmentDone:true};
let student3 : Student={name:"haris",seniorstatus:false,assignmentDone:false};
let student4 : Student={name:"umar",seniorstatus:true,assignmentDone:true};
let student5 : Student={name:"Taha",seniorstatus:false,assignmentDone:false};
...
console.log("\n\n \t Assignment No. 4 \n\n ")
 function seniorassignmentdone(name:Student[]){
...
function updateclasslist(name:Student[]){
  for(let i=0;i<student.length;i++){
